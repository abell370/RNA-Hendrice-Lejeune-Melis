...
double SimplePerceptron::executeOneIteration(int indexOfPredictedData, bool updateWeights)
{
	/*
	this->iterations += 1;
	this->nbErreurs = 0;
...
double SimplePerceptron::calculMeanQuadratic(int indexOfPredictedData)
{
	double E = 0.;
